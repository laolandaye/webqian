...
public class XMLDom4j {
    ...
    private final static org.slf4j.Logger logger = LoggerFactory.getLogger(XMLDom4j.class);
     ...
     * @return
     */
    private static Document getDocumentByString(String xmlStr) {
        Document doc = null;
        try {
     ...
     * @return       Document
     */
    private static Document getDocumentByFile(MultipartFile file){
